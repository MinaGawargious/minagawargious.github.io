...
const defaultColors = {
  ...
  primary: {
    main: '#00bcd4',        // Main primary color (dark mode)
  ...
  scrollbar: {
    ...
    thumb: {
      dark: '#00bcd4',       // Scrollbar thumb color (dark mode)
  ...
  cursor: {
    ...
    accent: {
      dark: '#00bcd4',      // Accent cursor color (dark mode)
      light: '#00bcd4',     // Accent cursor color (light mode)
    },
  },
};
